...
export const EditAddressModal = ({ location, city, plaque, postalCode, unit, transferee, transfereePhone, transfereeEmail }) => {
    ...
    const [postalData, setPostalData] = useState(postalCode);
    const [recipientName, setRecipientName] = useState(transferee);
    const [recipientPhone, setRecipientPhone] = useState(transfereePhone);
    const [recipientEmail, setRecipientEmail] = useState(transfereeEmail);
    const [isRecipient, setIsRecipient] = useState(false);
    ...
    const changeForm = () => {
        if (isRecipient === true) {
            ...
            // setRecipientPhone("");
            // setRecipientEmail("");
            setRecipientName(transferee);
            setRecipientPhone(transfereePhone);
            setRecipientEmail(transfereeEmail);
        }
    }
    ...
    return (
        <div class="modal fade" id="edit-address-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body my-1">

                        <button className="btn btn-primary btn-block" onClick={result}>Result</button>
                        <div className="d-flex justify-content-between">
                            <div className="">
                                <h5 className='font-weight-normal mb-1' style={{ fontSize: "1.2rem" }}>Edit Address</h5>
                                <div style={{ background: "#169632", width: "75%", height: "1.5px" }}></div>
                            </div>
                            <span aria-hidden="true" className='close' data-dismiss="modal">&times;</span>
                        </div>
                        ...
                        <div className="dropdown-divider mt-4"></div>
                        <div className="pt-2">
                            <span className='d-inline mr-3 font-weight-bold' style={{ color: "#169632", cursor: "pointer" }} onClick={editAddressApi}>Add</span>
                            <span className='d-inline font-weight-normal text-black-50' style={{ cursor: "pointer" }} data-dismiss="modal">Close</span>
                        </div>
